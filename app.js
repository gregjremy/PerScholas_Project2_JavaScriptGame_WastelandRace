...
// ***************Class Template***************
// Button that "starts" the game by prompting user to enter name
const btn = document.createElement('button')
btn.innerText = 'Start Game'
document.body.appendChild(btn)
btn.addEventListener('click', () => {
    userName = prompt("Welcome to Wasteland Race! Please enter your name.", "Enter player name")
// ******************************PLAYERS******************************
...
// ***************Class Template***************
    ...
    // Each Block will be put into a div
    // Assign each div a number value equal to each Block's blockPosition(i.e. 1-33)
    // A marker will be made for each player; This marker will "move" to a block based on playerPosition
    // A player method, checkBlock will check if the current block has a "special" and execute accordingly
    const gameBoard = [
    ...
    const gameObject = {
        runGame: function(){
            while(playerOne.playerPosition < 34 || computerAlpha.playerPosition < 34){  // While either player's position is less than 34...
                playerOne.rollGameDie() // playerOne rolls Die
                if(playerOne.playerPosition>34){    // check to see if after the move, playerOne has made it past finish...
                    ...
                    break   // ... If so, player has won; break the loop and end the game
                }
                computerAlpha.rollGameDie() // Otherwise, computer's turn
                if(computerAlpha.playerPosition>34){    // If computer makes it past finish...
                    ...
                    break   // Computer has won; break the loop and end the game
                }
